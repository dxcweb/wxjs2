...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WopUploadImgToOssExamples = function (_Component) {
	    _inherits(WopUploadImgToOssExamples, _Component);
	
	    function WopUploadImgToOssExamples() {
	        var _temp, _this, _ret;
	
	        _classCallCheck(this, WopUploadImgToOssExamples);
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
	            loading: false,
	            serverIds: []
	        }, _this.wop_url = "http://wop.dxcweb.com/service/", _this.wx_app_id = "wx5f069426b7e49373", _temp), _possibleConstructorReturn(_this, _ret);
	    }
	
	    WopUploadImgToOssExamples.prototype.componentDidMount = function componentDidMount() {
	        //复制调试
	        new _clipboard2.default('.btn');
	    };
	
	    WopUploadImgToOssExamples.prototype.getImageUrl = function getImageUrl(value) {
	    ...
	    WopUploadImgToOssExamples.prototype.uploadImage = function uploadImage(serverId, localId, callback) {
	        var me = this;
	        var serverIds = this.state.serverIds;
	
	        serverIds.push(serverId);
	        this.setState({ serverIds: serverIds });
	        (0, _wxjs.WopUploadImgToOss)(me.wop_url, me.wx_app_id, serverId).then(function (res) {
	            if (res.result) {
	    ...
	    WopUploadImgToOssExamples.prototype.onLoading = function onLoading(loading) {
	        if (loading) {
	    ...
	    WopUploadImgToOssExamples.prototype.render = function render() {
	        var me = this;
	        var serverIds = me.state.serverIds;
	
	        return _react2.default.createElement(
	            _wxjs.WopSign,
	            { url: this.wop_url, wx_app_id: this.wx_app_id },
	    ...
	    return WopUploadImgToOssExamples;
	}(_react.Component);
	
	_reactDom2.default.render(_react2.default.createElement(WopUploadImgToOssExamples, null), document.getElementById('__react-content'));
...
//# sourceMappingURL=3.WopUploadImgToOss.js.map